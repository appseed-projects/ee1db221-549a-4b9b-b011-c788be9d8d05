...
- Timestamp: `2022-06-13 03:49`
- Build ID: `ee1db221-549a-4b9b-b011-c788be9d8d05`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ee1db221-549a-4b9b-b011-c788be9d8d05.git
$ cd ee1db221-549a-4b9b-b011-c788be9d8d05
```
